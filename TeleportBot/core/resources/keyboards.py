...
def get_keyboard(key, language='ru') -> Union[ReplyKeyboardRemove, ReplyKeyboardMarkup, InlineKeyboardMarkup]:
    if key == 'remove':
        ...
        return _create_keyboard([[get_string('languages.ru', language), get_string('languages.uz'), get_string('languages.latuz')]], one_time=True)
    elif key == 'menu':
        keyboard = [
        ...
        if language == 'uz':
            keyboard = [[InlineKeyboardButton(get_string('languages.ru'), callback_data='languages:ru')],
                        [InlineKeyboardButton(get_string('languages.latuz'), callback_data='languages:latuz')]]
        elif language == 'ru':
            keyboard = [[InlineKeyboardButton(get_string('languages.uz'), callback_data='languages:uz')],
                        [InlineKeyboardButton(get_string('languages.latuz'), callback_data='languages:latuz')]]
        elif language == 'latuz':
            keyboard = [[InlineKeyboardButton(get_string('languages.ru'), callback_data='languages:ru')],
                        [InlineKeyboardButton(get_string('languages.uz'), callback_data='languages:uz')]]
        else:
            return None
        ...
        return InlineKeyboardMarkup(keyboard)
    elif key == 'subscription_btn':
        keyboard = [
            [InlineKeyboardButton(get_string('subscription_btn', language), callback_data='subscribed', url=Config.TELEGRAM_CHANNEL_LINK)],
            [InlineKeyboardButton(get_string('confirm_subscription', language), callback_data="confirm")]
        ]
        return InlineKeyboardMarkup(keyboard)
