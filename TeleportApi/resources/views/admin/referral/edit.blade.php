            ...
            <div class="block-content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group @error('latuz_description')is-invalid @enderror">
                                <label for="latuz_description">Описание UZ(Латынь)</label>
                                <textarea name="latuz_description" id="latuz_description"
                                          class="form-control">
                                {!! $referral->latuz_description !!}
                            </textarea>
                            </div>
                        </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <div class="form-material">
                                    <label for="image_latuz">Изображение UZ(Латынь)</label>
                                    <input type="file" name="image_latuz" id="image_latuz" class="form-control">
                                </div>
                            </div>
                            @if ($referral->image_latuz)
                                <img src="{{ asset('storage/' . $referral->getImageLatUz()) }}" alt="" class="img-thumbnail">
                            @endif
                        </div>
                </div>
                        ...
                        <div class="referral-level mt-20" style="border-bottom: 1px solid #eaecee;" id="referralLevel{{ $key }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <div class="form-material floating">
                                            <input type="text" name="levels[{{ $key }}][latuz_reward]" value="{{ $level->ru_reward }}" id="latuz_reward{{ $key }}" class="form-control">
                                            <label for="latuz_reward{{ $key }}">Награда UZ(Латынь)</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            <div class="form-material floating">
                                <input type="text" name="levels[{0}][latuz_reward]" id="latuz_reward{0}" class="form-control">
                                <label for="latuz_reward{0}">Награда UZ (Латынь)</label>
                            </div>
                        </div>
                    </div>
                </div>
